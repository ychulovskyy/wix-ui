...
All component APIs must be strongly typed, no accepting the `any` object//ALR or function?//. It may be harder to write, but it's much easier to use.
...
//ALR - should this be added for consistency or is it irrelevant in this context: **component.meta.ts**//

Component meta files add metadata to the component. This metadata is consumed by various tools from the auto-tools repo//ALR provide link to repo here?//.

...
interface TreeViewProps<T> extends CommonListViewProps, TreeViewItemViewProps<T>
{
...
export class TreeView<T> extends React.Component<TreeViewProps<T>> implements IListView
{
